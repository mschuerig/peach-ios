...
struct RhythmOffsetDetectionFeedbackView: View {
    let isCorrect: Bool?
...
#Preview("Correct") {
    RhythmOffsetDetectionFeedbackView(isCorrect: true, offsetPercentage: 4)
        .padding()
}

#Preview("Incorrect") {
    RhythmOffsetDetectionFeedbackView(isCorrect: false, offsetPercentage: 12)
        .padding()
}

#Preview("No Feedback") {
    RhythmOffsetDetectionFeedbackView(isCorrect: nil, offsetPercentage: nil)
        .padding()
}
