...
nonisolated struct CSVImportParserV1: CSVVersionedParser {
    ...
    func parse(lines: [String]) -> CSVImportParser.ImportResult {
        ...
        guard let headerLine = lines.first, !headerLine.isEmpty else {
            ...
            return CSVImportParser.ImportResult(pitchDiscriminations: pitchDiscriminations, pitchMatchings: pitchMatchings, rhythmOffsetDetections: [], continuousRhythmMatchings: [], errors: errors)
        }
