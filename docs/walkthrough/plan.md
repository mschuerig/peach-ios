...
- **Timing offset detection** — hearing a looped 4-sixteenth pattern and identifying whether the third note is early or late
...
| 3 | [Training sessions](./3-training-sessions.md) | `Core/Training/`, `Training/PitchDiscrimination/`, `Training/PitchMatching/`, `Training/TimingOffsetDetection/`, `Training/ContinuousRhythmMatching/` | done |
...
| 6 | [Screens & navigation](./6-screens-and-navigation.md) | `Start/`, `Training/PitchDiscrimination/`, `Training/PitchMatching/`, `Training/TimingOffsetDetection/`, `Training/ContinuousRhythmMatching/`, `Profile/`, `Settings/`, `Info/` | done |
