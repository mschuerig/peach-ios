...
**Open terminology:** A proper term for the note that carries the offset is unresolved (see `docs/planning-artifacts/tod-discipline-future-direction.md` § *Open: terminology*). Story 82.1 lands the first setting under a placeholder (working: "offset slot"); story 82.2 settles the term in consultation with Adam (`agent-music-domain-expert`); story 82.4 applies the rename across the introduced surface before further stories pile up additional placeholder strings.
