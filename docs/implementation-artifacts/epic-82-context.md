...
- **Preview rendering for patterns.** Decision deferred to 82.3 (text glyphs like `* - * *` vs. a small visual strip). Recommendation grounded in localization cost, accessibility, and Dynamic Type.
