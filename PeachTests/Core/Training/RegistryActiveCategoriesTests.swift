...
/// Empty payload type for the synthetic test fixture: this discipline never
/// produces or parses records, so the payload's shape is irrelevant — only
/// the protocol conformance is.
